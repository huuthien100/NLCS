...
<head>
    ...
    <title>PG - Strike Freedom Gundam</title>
                ...
                <div id="productCarousel" class="carousel slide" data-bs-ride="productCarousel">
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="../../asset/product/PG/PG-Strike Freedom Gundam/PG-Strike Freedom Gundam (1).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 1">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/PG/PG-Strike Freedom Gundam/PG-Strike Freedom Gundam (2).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 2">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/PG/PG-Strike Freedom Gundam/PG-Strike Freedom Gundam (3).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 3">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/PG/PG-Strike Freedom Gundam/PG-Strike Freedom Gundam (4).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 4">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/PG/PG-Strike Freedom Gundam/PG-Strike Freedom Gundam (5).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 5">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/PG/PG-Strike Freedom Gundam/PG-Strike Freedom Gundam (6).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 6">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/PG/PG-Strike Freedom Gundam/PG-Strike Freedom Gundam (7).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 7">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/PG/PG-Strike Freedom Gundam/PG-Strike Freedom Gundam (8).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 8">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/PG/PG-Strike Freedom Gundam/PG-Strike Freedom Gundam (9).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 9">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/PG/PG-Strike Freedom Gundam/PG-Strike Freedom Gundam (10).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 10">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/PG/PG-Strike Freedom Gundam/PG-Strike Freedom Gundam (11).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 11">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/PG/PG-Strike Freedom Gundam/PG-Strike Freedom Gundam (12).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 12">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/PG/PG-Strike Freedom Gundam/PG-Strike Freedom Gundam (13).jpg"
            ...
            <div class="col-lg-6 col-md-6">
                <div class="row">
                    <div class="col-lg-12 col-md-12">
                        <h1 id="product_name">Strike Freedom Gundam</h1>
                    </div>
                    <div class="col-lg-12 col-md-12">
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 bottom-rule">
                        <h2 class="product-price" style="color: red;">7,000,000 VNĐ</h2>
                    </div>
                </div>
                <hr>
                <div class="row">
                ...
                <div class="tab-content">
                    <div class="tab-pane fade show active" id="description" role="tabpanel"
                        ...
                        <p>Strike Freedom Gundam (PG - 1/60) là một trong những mẫu Gundam Perfect
                            Grade đẹp mắt nhất. <br>Mọi ánh nhìn sẽ đổ dồn vào nó khi bộ cánh 8 Super Dragoon phía sau
                            bung
                            mở đến điểm cực đại, phơi bày ra bộ khung cơ khí vàng bên trong. <br>Tư thế thần thánh này
                            đã
                            khiến biết bao người say mê, và ở phiên bản "hoàn hảo" này nó lại càng quyền lực hơn nữa.
                            <br>Một mẫu Gunpla thực sự đẳng cấp mà bạn nên có trong bộ sưu tập của mình.
                        </p>
                    ...
                    <div class="tab-pane fade" id="features" role="tabpanel" aria-labelledby="features-tab">
                        <ul>
                            ...
                            <li><strong>Trang bị:</strong> Beam Rifle x2, Railgun x2, Super Dragoon x8, Beam Shield</li>
                            <li><strong>Chức năng:</strong> Beam Rifle có thể kết hợp lại với nhau. Mẫu Strike Freedom Gundam tuyệt vời nhất, và có sự tinh chỉnh thiết kế của Katoki Hajime. Khi cách Super Dragoon mở ra, kích thước của mô hình sẽ tăng lên đáng kể, vô cùng hoành tráng và đẹp mắt.</li>
                            <li><strong>Decal:</strong> Decal dán, decal cà</li>
                            <li><strong>Đèn LED:</strong> Có đèn LED</li>
                            <li><strong>Đế dựng:</strong> Kèm đế lớn hỗ trợ tạo dáng</li>
