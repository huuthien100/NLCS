                ...
                <div id="productCarousel" class="carousel slide" data-bs-ride="productCarousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="../../asset/product/RG/RG-Zaku II/RG-Zaku II (1).jpg" class="d-block w-100"
                                alt="Ảnh sản phẩm 1">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/RG/RG-Zaku II/RG-Zaku II (2).jpg" class="d-block w-100"
                                alt="Ảnh sản phẩm 2">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/RG/RG-Zaku II/RG-Zaku II (3).jpg" class="d-block w-100"
                                alt="Ảnh sản phẩm 3">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/RG/RG-Zaku II/RG-Zaku II (4).jpg" class="d-block w-100"
                                alt="Ảnh sản phẩm 42">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/RG/RG-Zaku II/RG-Zaku II (5).jpg" class="d-block w-100"
                                alt="Ảnh sản phẩm 5">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/RG/RG-Zaku II/RG-Zaku II (6).jpg" class="d-block w-100"
                                alt="Ảnh sản phẩm 6">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/RG/RG-Zaku II/RG-Zaku II (7).jpg" class="d-block w-100"
                                alt="Ảnh sản phẩm 7">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/RG/RG-Zaku II/RG-Zaku II (8).jpg" class="d-block w-100"
                                alt="Ảnh sản phẩm 8">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/RG/RG-Zaku II/RG-Zaku II (9).jpg" class="d-block w-100"
                                alt="Ảnh sản phẩm 9">
                        </div>
            ...
            <div class="col-lg-6 col-md-6">
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 bottom-rule">
                        <h2 class="product-price" style="color: red;">700,000 VNĐ</h2>
                    </div>
                </div>
                <hr>
                <div class="row">
                ...
                <div class="tab-content">
                    <div class="tab-pane fade show active" id="description" role="tabpanel"
                        ...
                        <p>MS-06F ZAKU II - RG - 1/144 - Là một trong những
                            biến thể của dòng MS-06 Zaku II, xuất hiện lần đầu trong series anime Mobile Suit Gundam.
                            <br>Đây là một trong những mobile suit biểu tượng đặc trưng của series phim Gundam, được chế tạo
                            bởi Zeonic Company. </p>
                        <div class="image-container">
                            <img src="../../asset/product/RG/RG-Zaku II/RG-Zaku II (1).jpg"
                                alt="Ảnh sản phẩm 1">
                            <img src="../../asset/product/RG/RG-Zaku II/RG-Zaku II (2).jpg"
                                alt="Ảnh sản phẩm 2">
                            <img src="../../asset/product/RG/RG-Zaku II/RG-Zaku II (3).jpg"
                                alt="Ảnh sản phẩm 3">
                            <img src="../../asset/product/RG/RG-Zaku II/RG-Zaku II (4).jpg"
                                alt="Ảnh sản phẩm 4">
                            <img src="../../asset/product/RG/RG-Zaku II/RG-Zaku II (5).jpg"
                                alt="Ảnh sản phẩm 5">
                            <img src="../../asset/product/RG/RG-Zaku II/RG-Zaku II (6).jpg"
                                alt="Ảnh sản phẩm 6">
                            <img src="../../asset/product/RG/RG-Zaku II/RG-Zaku II (7).jpg"
                                alt="Ảnh sản phẩm 7">
                            <img src="../../asset/product/RG/RG-Zaku II/RG-Zaku II (8).jpg"
                                alt="Ảnh sản phẩm 8">
                            <img src="../../asset/product/RG/RG-Zaku II/RG-Zaku II (9).jpg"
                                alt="Ảnh sản phẩm 9">
                        </div>
                    </div>
                    ...
                    <div class="tab-pane fade" id="features" role="tabpanel" aria-labelledby="features-tab">
                        <ul>
                            ...
                            <li><strong>Thuộc Series:</strong> Mobile Suit Gundam</li>
                            <li><strong>Trang bị:</strong> Zaku Bazooka, Heat Hawk, Zaku Machine Gun.</li>
