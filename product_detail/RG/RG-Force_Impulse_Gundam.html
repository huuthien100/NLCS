...
<head>
    ...
    <title>RG - Force Impulse Gundam</title>
                ...
                <div id="productCarousel" class="carousel slide" data-bs-ride="productCarousel">
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="../../asset/product/RG/RG-Force Impulse Gundam/RG-Force Impulse Gundam (1).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 1">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/RG/RG-Force Impulse Gundam/RG-Force Impulse Gundam (2).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 2">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/RG/RG-Force Impulse Gundam/RG-Force Impulse Gundam (3).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 3">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/RG/RG-Force Impulse Gundam/RG-Force Impulse Gundam (4).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 4">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/RG/RG-Force Impulse Gundam/RG-Force Impulse Gundam (5).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 5">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/RG/RG-Force Impulse Gundam/RG-Force Impulse Gundam (6).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 6">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/RG/RG-Force Impulse Gundam/RG-Force Impulse Gundam (7).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 7">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/RG/RG-Force Impulse Gundam/RG-Force Impulse Gundam (8).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 8">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/RG/RG-Force Impulse Gundam/RG-Force Impulse Gundam (9).jpg"
            ...
            <div class="col-lg-6 col-md-6">
                <div class="row">
                    <div class="col-lg-12 col-md-12">
                        <h1 id="product_name">Force Impulse Gundam</h1>
                    </div>
                    <div class="col-lg-12 col-md-12">
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 bottom-rule">
                        <h2 class="product-price" style="color: red;">780,000 VNĐ</h2>
                    </div>
                </div>
                <hr>
                <div class="row">
                ...
                <div class="tab-content">
                    <div class="tab-pane fade show active" id="description" role="tabpanel"
                        ...
                        <p>Force Impulse Gundam (RG - 1/144) là mô hình Mobile Suit ZGMF-X56S Impulse
                            Gundam của Shinn Asuka trong Mobile Suit Gundam Seed Destiny. <br>Với độ chi tiết cực kì cao,
                            khả năng biến hình thành máy bay chiến đấu, đây chắc chắn là mẫu Gunpla mà bạn phải sở hữu
                            ngay! </p>
                    ...
                    <div class="tab-pane fade" id="features" role="tabpanel" aria-labelledby="features-tab">
                        <ul>
                            ...
                            <li><strong>Thuộc Series:</strong> Mobile Suit Gundam SEED Destiny</li>
                            <li><strong>Trang bị:</strong> High energy beam rifle, Mobile shield, Folding Razor vs Armored Knife, Silhouette flyer</li>
                            <li><strong>Decal:</strong> Decal dán</li>
                            <li><strong>Đế dựng:</strong> Không kèm đế dựng. (Mua riêng tại đây)</li>
