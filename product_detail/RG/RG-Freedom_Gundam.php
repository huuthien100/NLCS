                ...
                <div id="productCarousel" class="carousel slide" data-bs-ride="productCarousel">
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="../../asset/product/RG/RG-Freedom Gundam/RG-Freedom Gundam (1).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 1">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/RG/RG-Freedom Gundam/RG-Freedom Gundam (2).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 2">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/RG/RG-Freedom Gundam/RG-Freedom Gundam (3).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 3">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/RG/RG-Freedom Gundam/RG-Freedom Gundam (4).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 4">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/RG/RG-Freedom Gundam/RG-Freedom Gundam (5).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 5">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/RG/RG-Freedom Gundam/RG-Freedom Gundam (6).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 6">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/RG/RG-Freedom Gundam/RG-Freedom Gundam (7).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 7">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/RG/RG-Freedom Gundam/RG-Freedom Gundam (8).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 8">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/RG/RG-Freedom Gundam/RG-Freedom Gundam (9).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 9">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/RG/RG-Freedom Gundam/RG-Freedom Gundam (10).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 10">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/RG/RG-Freedom Gundam/RG-Freedom Gundam (11).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 11">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/RG/RG-Freedom Gundam/RG-Freedom Gundam (12).jpg"
            ...
            <div class="col-lg-6 col-md-6">
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 bottom-rule">
                        <h2 class="product-price" style="color: red;">760,000 VNĐ</h2>
                    </div>
                </div>
                <hr>
                <div class="row">
                ...
                <div class="tab-content">
                    <div class="tab-pane fade show active" id="description" role="tabpanel"
                        ...
                        <p>Freedom Gundam (RG - 1/144) là mô hình tái hiện lại Mobile Suit xuất hiện
                            trong Mobile Suit Gundam SEED và Mobile Suit Gundam SEED Destiny. <br>Đây cũng là Mobile Suit
                            được lái bởi Kira Yamato, thể hiện sự tự do với đôi cánh độc đáo, khả năng bay lượn tự do
                            trên bầu trời rộng lớn. </p>
                    ...
                    <div class="tab-pane fade" id="features" role="tabpanel" aria-labelledby="features-tab">
                        <ul>
                            ...
                            <li><strong>Trang bị:</strong> Beam saber x2, Beam Rifle, Shield, Rail Gun x2, Plasma Canon
                                x2</li>
                            <li><strong>Phần cánh kèm Plasma Canon:</strong> Chuyển động linh hoạt, tạo hình đẹp với độ
                                chi tiết cao</li>
                            <li><strong>Rail Gun bên hông:</strong> Mở ra, thu lại được</li>
                            <li><strong>Decal:</strong> Decal dán và decal kim loại</li>
                            <li><strong>Đế dựng:</strong> Không kèm đế dựng</li>
                            <li><strong>Xuất xứ:</strong> Chính hãng của Bandai, sản xuất tại Nhật Bản</li>
                        </ul>
                    </div>
