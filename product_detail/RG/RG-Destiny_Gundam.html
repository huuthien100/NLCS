                ...
                <div id="productCarousel" class="carousel slide" data-bs-ride="productCarousel">
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="../../asset/product/RG/RG-Destiny Gundam/RG-Destiny Gundam (1).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 1">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/RG/RG-Destiny Gundam/RG-Destiny Gundam (2).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 2">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/RG/RG-Destiny Gundam/RG-Destiny Gundam (3).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 3">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/RG/RG-Destiny Gundam/RG-Destiny Gundam (4).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 4">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/RG/RG-Destiny Gundam/RG-Destiny Gundam (5).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 5">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/RG/RG-Destiny Gundam/RG-Destiny Gundam (6).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 6">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/RG/RG-Destiny Gundam/RG-Destiny Gundam (7).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 7">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/RG/RG-Destiny Gundam/RG-Destiny Gundam (8).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 8">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/RG/RG-Destiny Gundam/RG-Destiny Gundam (9).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 9">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/RG/RG-Destiny Gundam/RG-Destiny Gundam (10).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 10">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/RG/RG-Destiny Gundam/RG-Destiny Gundam (11).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 11">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/RG/RG-Destiny Gundam/RG-Destiny Gundam (12).jpg"
            ...
            <div class="col-lg-6 col-md-6">
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 bottom-rule">
                        <h2 class="product-price" style="color: red;">770,000 VNĐ</h2>
                    </div>
                </div>
                <hr>
                <div class="row">
                ...
                <div class="tab-content">
                    <div class="tab-pane fade show active" id="description" role="tabpanel"
                        ...
                        <p>Với độ chi tiết và chất lượng của dòng sản phẩm Real Grade, ZGMF-X42S Destiny Gundam được tái
                            hiện lại vô cùng sống động và đẹp mắt.
                            <br>Mẫu Mobile Suit này sở hữu một bộ cánh siêu đẹp với
                            những phần lớn nhỏ, đường nét phối hợp hài hòa, vừa thanh tao lại khỏe khoắn. Hai vũ khí lớn
                            của Destiny Gundam là Beam Sword và Long Range Beam Canon cũng được thực hiện rất tốt.
                            <br>Bạn có thể gắn chúng sau lưng, thu gọn hay mở rộng y như trong phim.
                        </p>
                    ...
                    <div class="tab-pane fade" id="features" role="tabpanel" aria-labelledby="features-tab">
                        <ul>
                            ...
                            <li><strong>Độ chi tiết:</strong> Vô cùng chi tiết, có khung xương chuyển động linh hoạt.
                                Ráp theo kiểu bấm khớp, không cần dùng keo dán.</li>
                            <li><strong>Thuộc Series:</strong> Mobile Suit Gundam SEED</li>
                            <li><strong>Trang bị:</strong> Beam Rifle, Beam saber x2, Beam Boomerang x2, Beam Sword,
                                Long Range Beam Canon, Shield, Beam Shield</li>
                            <li><strong>Bộ cánh:</strong> Lớn, bung mở vô cùng đẹp mắt</li>
                            <li><strong>Decal:</strong> Decal dán</li>
                            <li><strong>Đế dựng:</strong> Không kèm đế dựng</li>
                            <li><strong>Xuất xứ:</strong> Chính hãng của Bandai Nhật Bản</li>
                        </ul>
