...
<head>
    ...
    <title>RG - RX-93 Nu V Gundam</title>
                ...
                <div id="productCarousel" class="carousel slide" data-bs-ride="productCarousel">
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="../../asset/product/RG/RG-RX-93 Nu V Gundam/RG-RX-93 Nu V Gundam (1).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 1">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/RG/RG-RX-93 Nu V Gundam/RG-RX-93 Nu V Gundam (2).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 2">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/RG/RG-RX-93 Nu V Gundam/RG-RX-93 Nu V Gundam (3).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 3">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/RG/RG-RX-93 Nu V Gundam/RG-RX-93 Nu V Gundam (4).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 4">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/RG/RG-RX-93 Nu V Gundam/RG-RX-93 Nu V Gundam (5).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 5">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/RG/RG-RX-93 Nu V Gundam/RG-RX-93 Nu V Gundam (6).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 6">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/RG/RG-RX-93 Nu V Gundam/RG-RX-93 Nu V Gundam (7).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 7">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/RG/RG-RX-93 Nu V Gundam/RG-RX-93 Nu V Gundam (8).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 8">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/RG/RG-RX-93 Nu V Gundam/RG-RX-93 Nu V Gundam (9).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 9">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/RG/RG-RX-93 Nu V Gundam/RG-RX-93 Nu V Gundam (10).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 10">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/RG/RG-RX-93 Nu V Gundam/RG-RX-93 Nu V Gundam (11).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 11">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/RG/RG-RX-93 Nu V Gundam/RG-RX-93 Nu V Gundam (12).jpg"
            ...
            <div class="col-lg-6 col-md-6">
                <div class="row">
                    <div class="col-lg-12 col-md-12">
                        <h1 id="product_name">RX-93 Nu V Gundam</h1>
                    </div>
                    <div class="col-lg-12 col-md-12">
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 bottom-rule">
                        <h2 class="product-price" style="color: red;">1,230,000 VNĐ</h2>
                    </div>
                </div>
                <hr>
                <div class="row">
                ...
                <div class="tab-content">
                    <div class="tab-pane fade show active" id="description" role="tabpanel"
                        ...
                        <p>Không còn nghi ngờ gì nữa, Nu Gundam (RG - 1/144) là một trong những
                            mẫu Gunpla RG đẹp nhất, tốt nhất từ trước đến nay. <br>Từng chi tiết giáp trụ, vũ khí đều được
                            tái hiện đẹp xuất sắc, xứng đáng với danh tiếng của Nu Gundam cao lớn. <br>Bên cạnh đó, khung
                            xương cũng được làm rất tốt, biên độ chuyển động ổn. Đã có Sazabi RG thì làm sao thiếu được
                            Nu Gundam chứ. </p>
                    ...
                    <div class="tab-pane fade" id="features" role="tabpanel" aria-labelledby="features-tab">
                        <ul>
                            <li><strong>Cấp độ:</strong> RG với tỷ lệ 1/144 vô cùng chi tiết</li>
                            <li><strong>Độ chi tiết:</strong> Cao, có khung xương chuyển động linh hoạt. Ráp theo kiểu bấm khớp, không cần dùng keo dán.</li>
                            <li><strong>Thuộc Series:</strong> Mobile Suit Gundam: Char's Counterattack</li>
                            <li><strong>Trang bị:</strong> Beam Rifle, Beam Saber x2, Large Beam Saber, New Hyper Bazooka, Shield (beam cannon), Fin Funnel x6, Missiles</li>
                            <li><strong>Đặc điểm:</strong> Các Fin Funnel có thể tách riêng, hoạt động độc lập rất đẹp mắt</li>
                            <li><strong>Decal:</strong> Decal dán</li>
                            <li><strong>Đế dựng:</strong> Không kèm đế dựng</li>
                            <li><strong>Xuất xứ:</strong> Chính hãng của Bandai</li>
                        </ul>
