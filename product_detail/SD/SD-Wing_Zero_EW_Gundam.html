...
<head>
    ...
    <title>SD - Wing Zero EW Gundam</title>
                ...
                <div id="productCarousel" class="carousel slide" data-bs-ride="productCarousel">
                    ...
                    <div class="carousel-inner">
                        ...
                        <div class="carousel-item">
                            <img src="../../asset/product/SD/SD-Wing Zero EW Gundam/SD-Wing Zero EW Gundam (2).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 2">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/SD/SD-Wing Zero EW Gundam/SD-Wing Zero EW Gundam (3).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 3">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/SD/SD-Wing Zero EW Gundam/SD-Wing Zero EW Gundam (4).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 4">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/SD/SD-Wing Zero EW Gundam/SD-Wing Zero EW Gundam (5).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 5">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/SD/SD-Wing Zero EW Gundam/SD-Wing Zero EW Gundam (6).jpg"
            ...
            <div class="col-lg-6 col-md-6">
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12">
                        <ul style="font-size: 18px; font-weight: bold;">
                            <li>Cấp độ: SD - Super Deformed</li>
                ...
                <div class="tab-content">
                    <div class="tab-pane fade show active" id="description" role="tabpanel"
                        ...
                        <p>Wing Zero EW Gundam - SD EX-STANDARD là phiên bản Gunpla tái hiện lại dấu ấn của Wing Zero EW Gundam trong
                            Gundam Wing: Endless Waltz. <br> Mẫu Gunpla này được thiết kế tinh xảo và chi tiết, với màu trắng bạc và
                            hình dáng đặc biệt.</p>
                    ...
                    <div class="tab-pane fade" id="features" role="tabpanel" aria-labelledby="features-tab">
                        <ul>
                            ...
                            <li><strong>Trang bị:</strong> Twin Buster Rifle, Beam Saber</li>
