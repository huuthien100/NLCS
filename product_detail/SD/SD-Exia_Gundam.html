                ...
                <div id="productCarousel" class="carousel slide" data-bs-ride="productCarousel">
                    ...
                    <div class="carousel-inner">
                        ...
                        <div class="carousel-item">
                            <img src="../../asset/product/SD/SD-Exia Gundam/SD-Exia Gundam (2).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 2">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/SD/SD-Exia Gundam/SD-Exia Gundam (3).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 3">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/SD/SD-Exia Gundam/SD-Exia Gundam (4).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 4">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/SD/SD-Exia Gundam/SD-Exia Gundam (5).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 5">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/SD/SD-Exia Gundam/SD-Exia Gundam (6).jpg"
            ...
            <div class="col-lg-6 col-md-6">
                ...
                <div class="tab-content">
                    <div class="tab-pane fade show active" id="description" role="tabpanel"
                        ...
                        <p>Exia Gundam - SD EX-STANDARD tái hiện lại Gundam của Setsuna F. Seiei
                            trong
                            Mobile Suit Gundam 00. <br>Mẫu Gunpla này được xây dựng nhằm tối ưu khả năng cận chiến, đấu
                            tay
                            đôi nên thiết kế vô cùng thon gọn đẹp mắt, màu sắc chủ đạo gồm xanh, đỏ, trắng cùng bộ vũ
                            khí đồ sộ.</p>
                    ...
                    <div class="tab-pane fade" id="features" role="tabpanel" aria-labelledby="features-tab">
                        <ul>
                            ...
                            <li><strong>Trang bị:</strong> GN Long Blade, GN Short Blade, GN Shield</li>
