                ...
                <div id="productCarousel" class="carousel slide" data-bs-ride="productCarousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="../../asset/product/SD/SD-00 Gundam/SD-00 Gundam (1).jpg" class="d-block w-100"
                                alt="Ảnh sản phẩm 1">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/SD/SD-00 Gundam/SD-00 Gundam (2).jpg" class="d-block w-100"
                                alt="Ảnh sản phẩm 2">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/SD/SD-00 Gundam/SD-00 Gundam (3).jpg" class="d-block w-100"
                                alt="Ảnh sản phẩm 3">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/SD/SD-00 Gundam/SD-00 Gundam (4).jpg" class="d-block w-100"
                                alt="Ảnh sản phẩm 4">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/SD/SD-00 Gundam/SD-00 Gundam (5).jpg" class="d-block w-100"
                                alt="Ảnh sản phẩm 5">
                        </div>
                    </div>
            ...
            <div class="col-lg-6 col-md-6">
                <div class="row">
                    <div class="col-lg-12 col-md-12">
                        <h1 id="product_name">00 Gundam</h1>
                    </div>
                    <div class="col-lg-12 col-md-12">
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 bottom-rule">
                        <h2 class="product-price" style="color: red;">250,000 VNĐ</h2>
                    </div>
                </div>
                <hr>
                <div class="row">
                ...
                <div class="tab-content">
                    <div class="tab-pane fade show active" id="description" role="tabpanel"
                        ...
                        <p>00 Gundam - SD EX-STANDARD là một trong những mẫu Gundam được rất nhiều
                            người yêu thích. <br>Mẫu Gunpla này có biên độ cử động tốt hơn so với các mẫu SD thông thường,
                            thể hiện được tính cơ động của 00 Gundam. <br>Twin Drive System cũng được tái hiện đẹp mắt cùng
                            với 2 thanh GN Sword II đi kèm, chắc chắn các fan của 00 Gundam không nên bỏ lỡ. </p>
                            <div class="image-container">
                                <img src="../../asset/product/SD/SD-00 Gundam/SD-00 Gundam (1).jpg" alt="Ảnh sản phẩm 1">
                                <img src="../../asset/product/SD/SD-00 Gundam/SD-00 Gundam (2).jpg" alt="Ảnh sản phẩm 2">
                                <img src="../../asset/product/SD/SD-00 Gundam/SD-00 Gundam (3).jpg" alt="Ảnh sản phẩm 3">
                                <img src="../../asset/product/SD/SD-00 Gundam/SD-00 Gundam (4).jpg" alt="Ảnh sản phẩm 4">
                                <img src="../../asset/product/SD/SD-00 Gundam/SD-00 Gundam (5).jpg" alt="Ảnh sản phẩm 5">
                            </div>                                                       
                    </div>

                    <div class="tab-pane fade" id="features" role="tabpanel" aria-labelledby="features-tab">
                        <ul>
                            <li><strong>Cấp độ:</strong> SD (Super Deformed) EX-Standard</li>
                            <li><strong>Tỷ lệ:</strong> Không có tỷ lệ cụ thể</li>
                            <li><strong>Độ chi tiết:</strong> Thấp</li>
                            <li><strong>Khớp chuyển động:</strong> Tương đối linh hoạt, ráp bằng cách bấm khớp (không cần keo dán)</li>
                            <li><strong>Đặc điểm:</strong> Dòng SD EX-Standard mới có đầu nhỏ hơn và tay chân dài hơn so với SD thông thường, cho phép cử động và tạo dáng tốt hơn.</li>
                            <li><strong>Trang bị:</strong> GN Sword II, Twin Drive System</li>
