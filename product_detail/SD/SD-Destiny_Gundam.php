                ...
                <div id="productCarousel" class="carousel slide" data-bs-ride="productCarousel">
                    ...
                    <div class="carousel-inner">
                        ...
                        <div class="carousel-item">
                            <img src="../../asset/product/SD/SD-Destiny Gundam/SD-Destiny Gundam (2).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 2">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/SD/SD-Destiny Gundam/SD-Destiny Gundam (3).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 3">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/SD/SD-Destiny Gundam/SD-Destiny Gundam (4).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 4">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/SD/SD-Destiny Gundam/SD-Destiny Gundam (5).jpg"
            ...
            <div class="col-lg-6 col-md-6">
                ...
                <div class="tab-content">
                    <div class="tab-pane fade show active" id="description" role="tabpanel"
                        ...
                        <p>Destiny Gundam - SD EX-STANDARD tái hiện lại Gundam của Shinn Asuka trong Mobile Suit Gundam
                            SEED Destiny.<br>Mẫu Gunpla này được thiết kế đẹp mắt, màu sắc chủ đạo gồm xanh, đỏ, trắng.
                        </p>
                    ...
                    <div class="tab-pane fade" id="features" role="tabpanel" aria-labelledby="features-tab">
                        <ul>
                            <li>
                                <strong>Cấp độ:</strong> SD (Super Deformed) EX-Standard
                            </li>
                            <li>
                                <strong>Tỷ lệ:</strong> Không có tỷ lệ cụ thể
                            </li>
                            <li>
                                <strong>Độ chi tiết:</strong> Thấp
                            </li>
                            <li>
                                <strong>Khớp chuyển động:</strong> Tương đối linh hoạt, ráp bằng cách bấm khớp (không
                                cần keo dán)
                            </li>
                            <li>
                                <strong>Đặc điểm:</strong> Dòng SD EX-Standard có đầu nhỏ hơn, tay và chân dài hơn so
                                với SD thông thường, cho phép cử động và tạo dáng tốt hơn.
                            </li>
                            <li>
                                <strong>Trang bị:</strong> High-Energy Beam Rifle, Long-Range Beam Cannon, "Arondight"
                                Beam Sword
                            </li>
                            <li>
                                <strong>Decal:</strong> Đính kèm decal dán
                            </li>
                            <li>
                                <strong>Đế:</strong> Không kèm đế
                            </li>
                            <li>
                                <strong>Xuất xứ:</strong> Sản phẩm Gunpla chính hãng của Bandai, sản xuất tại Nhật Bản
                            </li>
                        </ul>
                    </div>
