...
<head>
    ...
    <title>SD - Try Burning Gundam</title>
                ...
                <div id="productCarousel" class="carousel slide" data-bs-ride="productCarousel">
                    ...
                    <div class="carousel-inner">
                        ...
                        <div class="carousel-item">
                            <img src="../../asset/product/SD/SD-Try Burning Gundam/SD-Try Burning Gundam (2).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 2">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/SD/SD-Try Burning Gundam/SD-Try Burning Gundam (3).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 3">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/SD/SD-Try Burning Gundam/SD-Try Burning Gundam (4).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 4">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/SD/SD-Try Burning Gundam/SD-Try Burning Gundam (5).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 5">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/SD/SD-Try Burning Gundam/SD-Try Burning Gundam (6).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 6">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/SD/SD-Try Burning Gundam/SD-Try Burning Gundam (7).jpg"
            ...
            <div class="col-lg-6 col-md-6">
                <div class="row">
                    <div class="col-lg-12 col-md-12">
                        <h1 id="product_name">Try Burning Gundam</h1>
                    </div>
                    <div class="col-lg-12 col-md-12">
                ...
                <div class="tab-content">
                    <div class="tab-pane fade show active" id="description" role="tabpanel"
                        ...
                        <p>Try Burning Gundam - SD EX-STANDARD tái hiện lại Gunpla của Senkai Kamiki
                            trong Gundam Build Fighters Try.
                            <br>Mẫu Gunpla này được xây dựng nhằm tối ưu khả năng cận chiến, đấu
                            tay đôi nên thiết kế vô cùng thon gọn đẹp mắt, màu sắc chủ đạo gồm xanh, đỏ, trắng đậm chất
                            võ thuật.
                        </p>
                    ...
                    <div class="tab-pane fade" id="features" role="tabpanel" aria-labelledby="features-tab">
                        <ul>
                            ...
                            <li><strong>Khớp chuyển động:</strong> Tương đối linh hoạt, ráp bằng cách bấm khớp (không
                                cần keo dán)</li>
                            <li><strong>Đặc điểm:</strong> Dòng SD EX-Standard mới có đầu nhỏ hơn và tay chân dài hơn so
                                với SD thông thường, cho phép cử động và tạo dáng tốt hơn.</li>
                            <li><strong>Trang bị:</strong> Các hiệu ứng quyền thuật lửa</li>
                            <li><strong>Decal:</strong> Đính kèm decal dán</li>
                            <li><strong>Đế:</strong> Không kèm đế</li>
