...
<head>
    ...
    <title>MG - Avalanche Exia Dash Gundam</title>
                ...
                <div id="productCarousel" class="carousel slide" data-bs-ride="productCarousel">
                    <div class="carousel-inner">
                        ...
                        <div class="carousel-item">
                            <img src="../../asset/product/MG/MG-Avalanche Exia Dash Gundam/MG-Avalanche Exia Dash Gundam (2).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 2">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/MG/MG-Avalanche Exia Dash Gundam/MG-Avalanche Exia Dash Gundam (3).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 3">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/MG/MG-Avalanche Exia Dash Gundam/MG-Avalanche Exia Dash Gundam (4).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 4">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/MG/MG-Avalanche Exia Dash Gundam/MG-Avalanche Exia Dash Gundam (5).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 5">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/MG/MG-Avalanche Exia Dash Gundam/MG-Avalanche Exia Dash Gundam (6).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 6">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/MG/MG-Avalanche Exia Dash Gundam/MG-Avalanche Exia Dash Gundam (7).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 7">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/MG/MG-Avalanche Exia Dash Gundam/MG-Avalanche Exia Dash Gundam (8).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 8">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/MG/MG-Avalanche Exia Dash Gundam/MG-Avalanche Exia Dash Gundam (9).jpg"
            ...
            <div class="col-lg-6 col-md-6">
                <div class="row">
                    <div class="col-lg-12 col-md-12">
                        <h1 id="product_name">Avalanche Exia Dash Gundam</h1>
                    </div>
                    <div class="col-lg-12 col-md-12">
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 bottom-rule">
                        <h2 class="product-price" style="color: red;">1,850,000 VNĐ</h2>
                    </div>
                </div>
                <hr>
                <div class="row">
                ...
                <div class="tab-content">
                    <div class="tab-pane fade show active" id="description" role="tabpanel"
                        ...
                        <p>Gundam Avalanche Exia Dash (P-Bandai) (MG - 1/100) là một trong những
                            phiên bản Gundam Exia được yêu thích và truy lùng nhiều nhất. <br>Bộ giáp hỗ trợ Avalanche Armor
                            và Dash Unit cực đẹp, nhiều cơ chế đóng mở. <br>Bạn có thể gắn nguyên bộ vũ khí của Gundam Exia
                            phía sau lưng gọn gàng mà vẫn rất ngầu. <br>Ngay cả Dash Unit cũng được tái hiện hoàn hảo với GN
                            Claw và khả năng gắn Beam Saber mỗi bên. <br>Mẫu Gundam hoành tráng này còn tinh tế, kèm theo
                            sẵn cho bạn một Action Base để hỗ trợ tạo dáng trên không nữa đấy. Quá tuyệt vời cho các fan
                            Gundam Exia.
                        </p>
                    ...
                    <div class="tab-pane fade" id="features" role="tabpanel" aria-labelledby="features-tab">
                        <ul>
                            ...
                            <li><strong>Series:</strong> Mobile Suit Gundam 00 (phim Mobile Suit Gundam 00V: Battlefield Record)</li>
                            <li><strong>Trang bị:</strong> GN Long Blade, GN Short Blade, GN Beam Dagger, GN Beam Sabers x2, GN Sword Kai, GN Beam Swords x2, Shield</li>
                            <li><strong>Chức năng:</strong> Bộ giáp Avalanche Armor và Dash Unit chi tiết, siêu ấn tượng, nhiều cơ chế đóng mở. Vũ khí có thể cất gọn phía sau lưng. Dash Unit có thể tách riêng ra ngoài (chuyển sang high-mobility mode)</li>
                            <li><strong>Decal:</strong> Decal nước</li>
