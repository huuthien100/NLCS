                ...
                <div id="productCarousel" class="carousel slide" data-bs-ride="productCarousel">
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="../../asset/product/MG/MG-Banshee Gundam/MG-Banshee Gundam (1).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 1">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/MG/MG-Banshee Gundam/MG-Banshee Gundam (2).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 2">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/MG/MG-Banshee Gundam/MG-Banshee Gundam (3).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 3">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/MG/MG-Banshee Gundam/MG-Banshee Gundam (4).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 4">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/MG/MG-Banshee Gundam/MG-Banshee Gundam (5).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 5">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/MG/MG-Banshee Gundam/MG-Banshee Gundam (6).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 6">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/MG/MG-Banshee Gundam/MG-Banshee Gundam (7).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 7">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/MG/MG-Banshee Gundam/MG-Banshee Gundam (8).jpg"
            ...
            <div class="col-lg-6 col-md-6">
                <div class="row">
                    <div class="col-lg-12 col-md-12">
                        <h1 id="product_name">Banshee Gundam</h1>
                    </div>
                    <div class="col-lg-12 col-md-12">
                ...
                <div class="tab-content">
                    <div class="tab-pane fade show active" id="description" role="tabpanel"
                        ...
                        <p>Dựa trên Sư Tử Vàng, nhưng tên thân mật lại là "Kỳ Lân Đen", Unicorn Gundam 02 Banshee (MG -
                            1/100) quả là thú vị. <br>Phần giáp với tông
                            màu tối đã góp thêm phần ấn tượng cho bộ psycho frame sắc vàng khi nó lộ ra ở Destroy Mode.
                            <br>Bên cạnh đó Armed Armor BS bên tay phải và bộ vuốt Armed Armor VN bên tay trái, hai vũ
                            khí
                            đặc biệt của Banshee cũng được tái hiện tuyệt vời trong bộ Gunpla này, tạo độ ngầu khó chê.
                        </p>
                        <div class="image-container">
                            <img src="../../asset/product/MG/MG-Banshee Gundam/MG-Banshee Gundam (1).jpg" alt="Ảnh sản phẩm 1">
                            <img src="../../asset/product/MG/MG-Banshee Gundam/MG-Banshee Gundam (2).jpg" alt="Ảnh sản phẩm 2">
                            <img src="../../asset/product/MG/MG-Banshee Gundam/MG-Banshee Gundam (3).jpg" alt="Ảnh sản phẩm 3">
                            <img src="../../asset/product/MG/MG-Banshee Gundam/MG-Banshee Gundam (4).jpg" alt="Ảnh sản phẩm 4">
                            <img src="../../asset/product/MG/MG-Banshee Gundam/MG-Banshee Gundam (5).jpg" alt="Ảnh sản phẩm 5">
                            <img src="../../asset/product/MG/MG-Banshee Gundam/MG-Banshee Gundam (6).jpg" alt="Ảnh sản phẩm 6">
                            <img src="../../asset/product/MG/MG-Banshee Gundam/MG-Banshee Gundam (7).jpg" alt="Ảnh sản phẩm 7">
                            <img src="../../asset/product/MG/MG-Banshee Gundam/MG-Banshee Gundam (8).jpg" alt="Ảnh sản phẩm 8">
                        </div>                        
                    </div>
                    ...
                    <div class="tab-pane fade" id="features" role="tabpanel" aria-labelledby="features-tab">
                        <ul>
                            ...
                            <li><strong>Series:</strong> Mobile Suit Gundam Unicorn</li>
                            <li><strong>Trang bị:</strong> Beam Saber, Armed Armor BS, Armed Armor VN</li>
                            <li><strong>Chức năng:</strong> Có thể chuyển dạng từ Unicorn Mode sang Destroy Mode và ngược lại</li>
