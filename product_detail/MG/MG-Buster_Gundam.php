                ...
                <div id="productCarousel" class="carousel slide" data-bs-ride="productCarousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="../../asset/product/MG/MG-Buster Gundam/MG-Buster Gundam (1).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 1">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/MG/MG-Buster Gundam/MG-Buster Gundam (2).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 2">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/MG/MG-Buster Gundam/MG-Buster Gundam (3).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 3">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/MG/MG-Buster Gundam/MG-Buster Gundam (4).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 4">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/MG/MG-Buster Gundam/MG-Buster Gundam (5).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 5">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/MG/MG-Buster Gundam/MG-Buster Gundam (6).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 6">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/MG/MG-Buster Gundam/MG-Buster Gundam (7).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 7">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/MG/MG-Buster Gundam/MG-Buster Gundam (8).jpg"
            ...
            <div class="col-lg-6 col-md-6">
                <div class="row">
                    <div class="col-lg-12 col-md-12">
                        <h1 id="product_name">Buster Gundam</h1>
                    </div>
                    <div class="col-lg-12 col-md-12">
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 bottom-rule">
                        <h2 class="product-price" style="color: red;">900,000 VNĐ</h2>
                    </div>
                </div>
                <hr>
                <div class="row">
                ...
                <div class="tab-content">
                    <div class="tab-pane fade show active" id="description" role="tabpanel"
                        ...
                        <p>Nếu có một cuộc thi súng hoành tráng trong giới Gundam thì chắc chắn Buster Gundam (MG -
                            1/100) sẽ nằm trong top 3.
                            <br>Được trang bị 2 khẩu 350mm
                            Gun Launcher, 94mm High-energy Rifle hạng nặng, bạn tha hồ đổi kiểu, tạo dáng hầm hố cho
                            Buster Gundam.
                            <br>Thậm chí, 2 khẩu súng này còn có thể hợp lại với nhau để tạo thành một thứ
                            còn dữ dội hơn, ngầu hơn nữa.
                            <br>Khi không chiến đấu, chúng có thể nằm gọn sau hai vai của
                            Mobile Suit này. Bên cạnh đó, những đường nét giáp trụ đẹp mắt, gọn gàng cũng là điểm khiến
                            nhiều người yêu thích Buster Gundam (MG - 1/100).
                        </p>
                    ...
                    <div class="tab-pane fade" id="features" role="tabpanel" aria-labelledby="features-tab">
                        <ul>
                            ...
                            <li><strong>Trang bị:</strong> 350mm Gun Launcher, 94mm High-energy Rifle</li>
                            <li><strong>Đặc điểm:</strong> Hai khẩu 350mm Gun Launcher và 94mm High-energy Rifle có thể kết hợp lại thành súng siêu lớn, hoặc gắn phía sau lưng gọn gàng. Missile Pod ở hai bên vai có thể mở ra được.</li>
                            <li><strong>Decal:</strong> Decal dán và decal cà</li>
