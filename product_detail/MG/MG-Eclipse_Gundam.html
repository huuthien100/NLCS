                ...
                <div id="productCarousel" class="carousel slide" data-bs-ride="productCarousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="../../asset/product/MG/MG-Eclipse Gundam/MG-Eclipse Gundam (1).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 1">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/MG/MG-Eclipse Gundam/MG-Eclipse Gundam (2).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 2">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/MG/MG-Eclipse Gundam/MG-Eclipse Gundam (3).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 3">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/MG/MG-Eclipse Gundam/MG-Eclipse Gundam (4).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 4">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/MG/MG-Eclipse Gundam/MG-Eclipse Gundam (5).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 5">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/MG/MG-Eclipse Gundam/MG-Eclipse Gundam (6).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 6">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/MG/MG-Eclipse Gundam/MG-Eclipse Gundam (7).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 7">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/MG/MG-Eclipse Gundam/MG-Eclipse Gundam (8).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 8">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/MG/MG-Eclipse Gundam/MG-Eclipse Gundam (9).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 9">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/MG/MG-Eclipse Gundam/MG-Eclipse Gundam (10).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 10">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/MG/MG-Eclipse Gundam/MG-Eclipse Gundam (11).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 11">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/MG/MG-Eclipse Gundam/MG-Eclipse Gundam (12).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 12">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/MG/MG-Eclipse Gundam/MG-Eclipse Gundam (13).jpg"
            ...
            <div class="col-lg-6 col-md-6">
                <div class="row">
                    <div class="col-lg-12 col-md-12">
                        <h1 id="product_name">Eclipse Gundam</h1>
                    </div>
                    <div class="col-lg-12 col-md-12">
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 bottom-rule">
                        <h2 class="product-price" style="color: red;">1,600,000 VNĐ</h2>
                    </div>
                </div>
                <hr>
                <div class="row">
                ...
                <div class="tab-content">
                    <div class="tab-pane fade show active" id="description" role="tabpanel"
                        ...
                        <p>
                            MVF-X08 Eclipse Gundam - MG - 1/100 sở hữu khả năng biến hình qua lại giữa dạng MS (mobile
                            suit) và Flight Form (phi thuyền chiến đấu) ấn tượng.
                            <br>Đặc biệt ở chỗ kiểu biến hình phi thuyền của Eclipse Gundam thực sự đẹp. Khác với đại đa số
                            các mẫu Gundam, Mobile Suit chuyển dạng thàng phi thuyền được trước đây, Eclipse Gundam dùng
                            2 mũi chân để làm đầu phi thuyền, còn cơ thể phía sau là khoang chỉ huy nhô lên cao. Kiểu
                            giáng tổng thể như một chiến hạm loại nhỏ.
                        </p>
                    ...
                    <div class="tab-pane fade" id="features" role="tabpanel" aria-labelledby="features-tab">
                        <ul>
                            ...
                            <li><strong>Series:</strong> Mobile Suit Gundam SEED ECLIPSE</li>
                            <li><strong>Trang bị:</strong> Beam Rifle, Beam Saber, Beam shield, bộ hiệu ứng phụ</li>
                            <li><strong>Decal:</strong> Decal dán</li>
                            <li><strong>Đế dựng:</strong> Có kèm đế dựng Action Base</li>
