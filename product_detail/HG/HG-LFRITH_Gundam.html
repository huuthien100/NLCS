                ...
                <div id="productCarousel" class="carousel slide" data-bs-ride="productCarousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="../../asset/product/HG/HG-LFRITH Gundam/HG-LFRITH Gundam (1).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 1">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/HG/HG-LFRITH Gundam/HG-LFRITH Gundam (2).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 2">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/HG/HG-LFRITH Gundam/HG-LFRITH Gundam (3).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 3">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/HG/HG-LFRITH Gundam/HG-LFRITH Gundam (4).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 4">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/HG/HG-LFRITH Gundam/HG-LFRITH Gundam (5).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 5">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/HG/HG-LFRITH Gundam/HG-LFRITH Gundam (6).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 6">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/HG/HG-LFRITH Gundam/HG-LFRITH Gundam (7).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 7">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/HG/HG-LFRITH Gundam/HG-LFRITH Gundam (8).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 8">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/HG/HG-LFRITH Gundam/HG-LFRITH Gundam (9).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 9">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/HG/HG-LFRITH Gundam/HG-LFRITH Gundam (10).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 10">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/HG/HG-LFRITH Gundam/HG-LFRITH Gundam (11).jpg"
            ...
            <div class="col-lg-6 col-md-6">
                <div class="row">
                    <div class="col-lg-12 col-md-12">
                        <h1 id="product_name">LFRITH Gundam</h1>
                    </div>
                    <div class="col-lg-12 col-md-12">
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 bottom-rule">
                        <h2 class="product-price" style="color: red;">580,000 VNĐ</h2>
                    </div>
                </div>
                <hr>
                <div class="row">
                ...
                <div class="tab-content">
                    <div class="tab-pane fade show active" id="description" role="tabpanel"
                        ...
                        <p>
                            Có rất nhiều điều có thể tán thưởng về thiết kế của
                            Gundam Lfrith.
                            <br>Đặc biệt nhất và phải nhắc đến đầu tiên là trang bị Compo GUND-BIT Shield của nó. Chiếc
                            khiên
                            này sử dụng hệ thống GUND-BIT, có khả năng phân tách thành 7 Bit Stave đơn lẻ. Các Bit Stave
                            này vừa có thể bay độc lập, tấn công và phòng thủ linh hoạt như funnel, lại vừa có thể kết
                            hợp vào các bộ phận giáp, vũ khí khác của Gundam Lfrith.
                            <br>Bit Stave gắn vào Receiver Gun tạo thành GUND-BIT Rifle, bắn beam mạnh hơn. Bit Stave
                            gắn vào backpack sau lưng đổi Gundam
                            Lfrith sang chế độ Bit on Form, tăng khả năng di chuyển, điều hướng.
                            <br>Bên cạnh đó, hệ thống khớp của Gundam Lfrith HG 1/144 có biên độ cử động vô cùng đáng
                            nể. Các động tác xoạc chân, ngồi xổm, quỳ không những làm được và còn làm rất đẹp mắt.
                        </p>
