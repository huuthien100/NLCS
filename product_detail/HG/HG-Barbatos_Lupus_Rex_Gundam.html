...
<head>
    ...
    <title>HG - Barbatos Lupus Rex Gundam</title>
                ...
                <div id="productCarousel" class="carousel slide" data-bs-ride="productCarousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="../../asset/product/HG/HG-Barbatos Lupux Rex Gundam/HG-Barbatos Lupus Rex (1).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 1">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/HG/HG-Barbatos Lupux Rex Gundam/HG-Barbatos Lupus Rex (2).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 2">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/HG/HG-Barbatos Lupux Rex Gundam/HG-Barbatos Lupus Rex (3).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 3">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/HG/HG-Barbatos Lupux Rex Gundam/HG-Barbatos Lupus Rex (4).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 4">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/HG/HG-Barbatos Lupux Rex Gundam/HG-Barbatos Lupus Rex (5).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 5">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/HG/HG-Barbatos Lupux Rex Gundam/HG-Barbatos Lupus Rex (6).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 6">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/HG/HG-Barbatos Lupux Rex Gundam/HG-Barbatos Lupus Rex (7).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 7">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/HG/HG-Barbatos Lupux Rex Gundam/HG-Barbatos Lupus Rex (8).jpg"
            ...
            <div class="col-lg-6 col-md-6">
                <div class="row">
                    <div class="col-lg-12 col-md-12">
                        <h1 id="product_name">Barbatos Lupus Rex Gundam</h1>
                    </div>
                    <div class="col-lg-12 col-md-12">
                ...
                <div class="tab-content">
                    <div class="tab-pane fade show active" id="description" role="tabpanel"
                        ...
                        <p>Gundam Barbatos Lupus Rex (HGIBO - 1/144) là ngôi sao lớn của series Gundam Iron-Blooded
                            Orphans, một "mãnh thú" đúng nghĩa về cả sức mạnh lẫn phong cách
                            tấn công bạo liệt. <br>Ngoài cây chùy khổng lồ thì bộ móng vuốt và chiếc đuôi của Barbatos
                            Lupus
                            Rex cũng là một vũ khí nguy hiểm chết người. </p>
                    ...
                    <div class="tab-pane fade" id="features" role="tabpanel" aria-labelledby="features-tab">
                        <ul>
                            ...
                            <li><strong>Thuộc Series:</strong> Gundam Iron-Blooded Orphans</li>
                            <li><strong>Trang bị:</strong> Ultra Large Mace, Tail Blade, Rex Nail</li>
                            <li><strong>Ultra Large Mace:</strong> Gắn sau lưng được</li>
                            <li><strong>Chiếc đuôi kiến:</strong> Có khả năng uốn lượn linh hoạt</li>
