                ...
                <div id="productCarousel" class="carousel slide" data-bs-ride="productCarousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="../../asset/product/HG/HG-Destiny Gundam/HG-Destiny Gundam (1).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 1">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/HG/HG-Destiny Gundam/HG-Destiny Gundam (2).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 2">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/HG/HG-Destiny Gundam/HG-Destiny Gundam (3).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 3">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/HG/HG-Destiny Gundam/HG-Destiny Gundam (4).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 4">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/HG/HG-Destiny Gundam/HG-Destiny Gundam (5).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 5">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/HG/HG-Destiny Gundam/HG-Destiny Gundam (6).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 6">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/HG/HG-Destiny Gundam/HG-Destiny Gundam (7).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 7">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/HG/HG-Destiny Gundam/HG-Destiny Gundam (8).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 8">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/HG/HG-Destiny Gundam/HG-Destiny Gundam (9).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 9">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/HG/HG-Destiny Gundam/HG-Destiny Gundam (10).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 10">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/HG/HG-Destiny Gundam/HG-Destiny Gundam (11).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 11">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/HG/HG-Destiny Gundam/HG-Destiny Gundam (12).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 12">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/HG/HG-Destiny Gundam/HG-Destiny Gundam (13).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 13">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/HG/HG-Destiny Gundam/HG-Destiny Gundam (14).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 14">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/HG/HG-Destiny Gundam/HG-Destiny Gundam (15).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 15">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/HG/HG-Destiny Gundam/HG-Destiny Gundam (16).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 16">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/HG/HG-Destiny Gundam/HG-Destiny Gundam (17).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 17">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/HG/HG-Destiny Gundam/HG-Destiny Gundam (18).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 18">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/HG/HG-Destiny Gundam/HG-Destiny Gundam (19).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 19">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/HG/HG-Destiny Gundam/HG-Destiny Gundam (20).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 20">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/HG/HG-Destiny Gundam/HG-Destiny Gundam (21).jpg"
            ...
            <div class="col-lg-6 col-md-6">
                <div class="row">
                    <div class="col-lg-12 col-md-12">
                        <h1 id="product_name">Destiny Gundam</h1>
                    </div>
                    <div class="col-lg-12 col-md-12">
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 bottom-rule">
                        <h2 class="product-price" style="color: red;">650,000 VNĐ</h2>
                    </div>
                </div>
                <hr>
                <div class="row">
                ...
                <div class="tab-content">
                    <div class="tab-pane fade show active" id="description" role="tabpanel"
                        ...
                        <p>Destiny Gundam (Revive Ver.) (HGCE - 1/144) là phiên bản mới với rất nhiều
                            cải tiến tuyệt vời. <br>Không chỉ chất lượng nhựa tốt hơn, khớp cử động biên độ rộng hơn, độ
                            chi
                            tiết cao hơn, mà nó còn sở hữu cả part hiệu ứng Wings of Light trứ danh của Destiny Gundam,
                            vũ khí thì nhiều và đẹp. <br>Thực sự, đây là một mẫu HG cực kỳ đáng sở hữu dành cho các fan
                            của
                            Gundam SEED nói riêng, và fan Gundam nói chung.
                        </p>
                    ...
                    <div class="tab-pane fade" id="features" role="tabpanel" aria-labelledby="features-tab">
                        <ul>
                            ...
                            <li><strong>Thuộc Series:</strong> Mobile Suit Gundam SEED</li>
                            <li><strong>Trang bị:</strong> Long Range Energy Cannon, Beam Rifle, Arondight Anti-Ship
                                Sword, Beam Boomerang, Beam Shield</li>
