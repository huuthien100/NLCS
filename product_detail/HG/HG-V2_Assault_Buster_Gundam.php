...
<head>
    ...
    <title>HG - V2 Assault Buster Gundam</title>
                ...
                <div id="productCarousel" class="carousel slide" data-bs-ride="productCarousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="../../asset/product/HG/HG-V2 Assault Buster Gundam/HG-V2 Assault Buster Gundam (1).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 1">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/HG/HG-V2 Assault Buster Gundam/HG-V2 Assault Buster Gundam (2).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 2">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/HG/HG-V2 Assault Buster Gundam/HG-V2 Assault Buster Gundam (3).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 3">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/HG/HG-V2 Assault Buster Gundam/HG-V2 Assault Buster Gundam (4).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 4">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/HG/HG-V2 Assault Buster Gundam/HG-V2 Assault Buster Gundam (5).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 5">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/HG/HG-V2 Assault Buster Gundam/HG-V2 Assault Buster Gundam (6).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 6">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/HG/HG-V2 Assault Buster Gundam/HG-V2 Assault Buster Gundam (7).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 7">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/HG/HG-V2 Assault Buster Gundam/HG-V2 Assault Buster Gundam (8).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 8">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/HG/HG-V2 Assault Buster Gundam/HG-V2 Assault Buster Gundam (9).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 9">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/HG/HG-V2 Assault Buster Gundam/HG-V2 Assault Buster Gundam (10).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 10">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/HG/HG-V2 Assault Buster Gundam/HG-V2 Assault Buster Gundam (11).jpg"
            ...
            <div class="col-lg-6 col-md-6">
                <div class="row">
                    <div class="col-lg-12 col-md-12">
                        <h1 id="product_name">V2 Assault Buster Gundam</h1>
                    </div>
                    <div class="col-lg-12 col-md-12">
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 bottom-rule">
                        <h2 class="product-price" style="color: red;">590,000 VNĐ</h2>
                    </div>
                </div>
                <hr>
                <div class="row">
                    <div class="col-lg-12 col-md-12">
                        <ul style="font-size: 18px; font-weight: bold;">
                            <li>Grade: HG - High Grade 1/144</li>
                ...
                <div class="tab-content">
                    <div class="tab-pane fade show active" id="description" role="tabpanel"
                        ...
                        <p>Đây là một bộ gunpla tuyệt vời khi cho bạn khả năng tái hiện tới ba kiểu "V2 Assault Gundam",
                            "V2 Assault Buster Gundam", và "V2 Buster Gundam" nhờ vào việc thay đổi các bộ phận trang bị
                            đi kèm. <br>Thích kiểu nào là đổi qua ngay kiểu đó, nhanh chóng, đẹp mắt. Victory 2 được vũ
                            trang tận răng.</p>
                    ...
                    <div class="tab-pane fade" id="features" role="tabpanel" aria-labelledby="features-tab">
                        <ul>
                            ...
                            <li><strong>Thuộc Series:</strong> Mobile Suit Victory Gundam</li>
                            <li><strong>Trang bị:</strong> Beam Rifle, Mega Beam Rifle, Mega Beam Shield, V2
                                Assault-Buster set</li>
                            <li><strong>Thay đổi trang bị:</strong> Có thể đổi các phần giáp để tạo ra kiểu trang bị
                                mình mong muốn</li>
