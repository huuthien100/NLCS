...
<head>
    ...
    <title>Tool - Mực kẻ line COR</title>
                ...
                <div id="productCarousel" class="carousel slide" data-bs-ride="productCarousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="../../asset/product/Tool/Mực kẻ line trắng.jpg" class="d-block w-100"
                                alt="Ảnh sản phẩm 1">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/Tool/Mực kẻ line đen.jpg" class="d-block w-100"
                                alt="Ảnh sản phẩm 1">
                        </div>
                    </div>
            ...
            <div class="col-lg-6 col-md-6">
                <div class="row">
                    <div class="col-lg-12 col-md-12">
                        <h1 id="product_name">Mực kẻ line COR</h1>
                    </div>
                    <div class="col-lg-12 col-md-12">
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12">
                        <ul style="font-size: 18px; font-weight: bold;">
                            <li>Thương hiệu: COR</li>
                            <li>Xuất xứ: Trung Quốc</li>
                        </ul>
                    </div>
                </div>
                <hr>
                <label for="color"><strong>Chọn màu mực:</strong></label>
                ...
                <div class="tab-content">
                    <div class="tab-pane fade show active" id="description" role="tabpanel"
                        ...
                        <p>Mực Kẻ Line COR với dung tích 40ml là sản phẩm chất lượng để tạo các đường kẻ tinh tế trên mô
                            hình và các sản phẩm thủ công khác. </p>
                        <div class="image-container">
                            <img src="../../asset/product/Tool/Mực kẻ line trắng.jpg" alt="Ảnh sản phẩm 1">
                            <img src="../../asset/product/Tool/Mực kẻ line đen.jpg" alt="Ảnh sản phẩm 2">
                        </div>
                    </div>

                    <div class="tab-pane fade" id="features" role="tabpanel" aria-labelledby="features-tab">
                        <ul>
                            <li><strong>Thương hiệu:</strong> COR</li>
