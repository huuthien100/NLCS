...
<head>
    ...
    <title>Tool - Keo dán Tamiya Extra Thin</title>
                ...
                <div id="productCarousel" class="carousel slide" data-bs-ride="productCarousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="../../asset/product/Tool/Keo dán Tamiya Extra Thin.jpg" class="d-block w-100"
                                alt="Ảnh sản phẩm 1">
                        </div>
                    </div>
            ...
            <div class="col-lg-6 col-md-6">
                <div class="row">
                    <div class="col-lg-12 col-md-12">
                        <h1 id="product_name">Keo dán Tamiya Extra Thin</h1>
                    </div>
                    <div class="col-lg-12 col-md-12">
                        <span class="badge bg-primary" id="category">Tool</span>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 bottom-rule">
                        <h2 class="product-price" style="color: red;">220,000 VNĐ</h2>
                    </div>
                </div>
                <hr>
                <div class="row">
                ...
                <ul class="nav nav-tabs" id="myTabs" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                        <a class="nav-link" id="features-tab" data-bs-toggle="tab" href="#features" role="tab"
                            aria-controls="features" aria-selected="false">Tính năng</a>
                    </li>
                    <li class="nav-item" role="presentation">
                ...
                <div class="tab-content">
                    <div class="tab-pane fade show active" id="description" role="tabpanel"
                        ...
                        <p>Keo Mô Hình Tamiya Extra Thin Cement là sản phẩm chất lượng cao từ thương hiệu Tamiya, được
                            thiết kế đặc biệt cho người làm mô hình và sưu tập viên. <br>Với đặc tính siêu mỏng, dễ sử
                            dụng
                            và khô nhanh, sản phẩm này giúp kết nối các chi tiết mô hình một cách chính xác và gọn gàng,
                            đồng thời đảm bảo chất lượng cao trong quá trình lắp ráp. <br>Đây là công cụ quan trọng để
                            tạo
                            ra các mô hình đẹp và chi tiết.</p>
                        <div class="image-container">
                            <img src="../../asset/product/Tool/Keo dán Tamiya Extra Thin.jpg" alt="Ảnh sản phẩm 1">
                        </div>
                    </div>

                    <div class="tab-pane fade" id="features" role="tabpanel" aria-labelledby="features-tab">
                        <ul>
                            <li><strong>Thương hiệu:</strong> Tamiya</li>
                            <li><strong>Xuất xứ:</strong> Nhật Bản</li>
                            <li><strong>Chất liệu:</strong> Keo</li>
                        </ul>
                    </div>
