...
<head>
    ...
    <title>Tool - Sơn Màu Tamiya</title>
                ...
                <div id="productCarousel" class="carousel slide" data-bs-ride="productCarousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="../../asset/product/Tool/Sơn Màu Tamiya.jpg" class="d-block w-100"
                                alt="Ảnh sản phẩm 1">
                        </div>
                    </div>
            ...
            <div class="col-lg-6 col-md-6">
                <div class="row">
                    <div class="col-lg-12 col-md-12">
                        <h1 id="product_name">Sơn Màu Tamiya</h1>
                    </div>
                    <div class="col-lg-12 col-md-12">
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 bottom-rule">
                        <h2 class="product-price" style="color: red;">65,000 VNĐ</h2>
                    </div>
                </div>
                <hr>
                <div class="row">
                    <div class="col-lg-12 col-md-12">
                        <ul style="font-size: 18px; font-weight: bold;">
                            ...
                            <li>Dung tích: 10ml</li>
                        </ul>
                    </div>
                </div>
                <hr>
                <label for="color"><strong>Chọn màu sơn:</strong></label>
                <select id="color" name="color">
                    ...
                    <option value="Vàng Sáng">Vàng Sáng</option>
                ...
                <div class="tab-content">
                    <div class="tab-pane fade show active" id="description" role="tabpanel"
                        ...
                        <p>Sơn màu Tamiya là sản phẩm chất lượng cao từ Nhật Bản, được thiết kế cho việc sơn và tạo màu
                            trên mô hình và các sản phẩm thủ công. <br>Với dung tích 10ml, sản phẩm này mang đến màu sắc
                            chính xác và sắc nét, thích hợp cho các dự án mô hình và thủ công.</p>
                        <div class="image-container">
                            <img src="../../asset/product/Tool/Sơn Màu Tamiya.jpg" alt="Ảnh sản phẩm 1">
                        </div>
                    </div>
                    ...
                    <div class="tab-pane fade" id="features" role="tabpanel" aria-labelledby="features-tab">
                        <ul>
                            ...
                            <li><strong>Dung tích:</strong> 10ml</li>
                        </ul>
                    </div>
