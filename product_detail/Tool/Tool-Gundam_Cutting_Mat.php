...
<head>
    ...
    <title>Tool - Gundam Cutting Mat</title>
                ...
                <div id="productCarousel" class="carousel slide" data-bs-ride="productCarousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="../../asset/product/Tool/Gundam Cutting Mat.jpg" class="d-block w-100"
                                alt="Ảnh sản phẩm 1">
                        </div>
                    </div>
            ...
            <div class="col-lg-6 col-md-6">
                <div class="row">
                    <div class="col-lg-12 col-md-12">
                        <h1 id="product_name">Gundam Cutting Mat</h1>
                    </div>
                    <div class="col-lg-12 col-md-12">
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 bottom-rule">
                        <h2 class="product-price" style="color: red;">100,000 VNĐ</h2>
                    </div>
                </div>
                <hr>
                <div class="row">
                ...
                <div class="tab-content">
                    <div class="tab-pane fade show active" id="description" role="tabpanel"
                        ...
                        <p>Bảng lót cắt cao su kích thước A4 là một công cụ hữu ích cho các hoạt động cắt và làm mô
                            hình. <br>Với chất liệu cao su chất lượng và kích thước tiêu chuẩn A4, nó cung cấp một bề
                            mặt lý
                            tưởng để cắt và làm việc với các chi tiết nhỏ. <br>Bề mặt cao su giúp bảo vệ bề mặt làm việc
                            của
                            bạn khỏi bị trầy xước và làm tăng độ chính xác trong quá trình cắt và tạo mô hình. <br>ó
                            cũng
                            có thể được sử dụng để đặt các chi tiết mô hình và giữ chúng ổn định trong quá trình lắp
                            ráp. </p>
                        <div class="image-container">
                            <img src="../../asset/product/Tool/Gundam Cutting Mat.jpg" alt="Ảnh sản phẩm 1">
                        </div>
                    </div>
                    ...
                    <div class="tab-pane fade" id="features" role="tabpanel" aria-labelledby="features-tab">
                        <ul>
                            ...
                            <li><strong>Chất liệu:</strong> Cao su</li>
                            <li><strong>Kích thước:</strong> A4</li>
                        </ul>
                    </div>
