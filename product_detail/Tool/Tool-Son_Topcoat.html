                ...
                <div id="productCarousel" class="carousel slide" data-bs-ride="productCarousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="../../asset/product/Tool/Sơn Topcoat.jpg" class="d-block w-100"
                                alt="Ảnh sản phẩm 1">
                        </div>
                    </div>
            ...
            <div class="col-lg-6 col-md-6">
                <div class="row">
                    <div class="col-lg-12 col-md-12">
                        <h1 id="product_name">Sơn Topcoat</h1>
                    </div>
                    <div class="col-lg-12 col-md-12">
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12">
                        <ul style="font-size: 18px; font-weight: bold;">
                            <li>Thương hiệu: Mr.Hobby</li>
                            <li>Xuất xứ: Nhật Bản</li>
                            <li>Chất liệu: Bình sơn thép chống gỉ</li>
                        </ul>
                    </div>
                </div>
                <hr>
                ...
                <div class="tab-content">
                    <div class="tab-pane fade show active" id="description" role="tabpanel"
                        ...
                        <p>Bình sơn thép chống gỉ của thương hiệu Mr.Hobby, sản phẩm xuất xứ từ Nhật Bản, là một lựa
                            chọn tốt để bảo vệ và tạo lớp sơn chống gỉ cho các bề mặt thép.</p>
                        <div class="image-container">
                            <img src="../../asset/product/Tool/Sơn Topcoat.jpg" alt="Ảnh sản phẩm 1">
                        </div>
                    </div>

                    <div class="tab-pane fade" id="features" role="tabpanel" aria-labelledby="features-tab">
                        <ul>
                            <li><strong>Thương hiệu:</strong> Mr.Hobby</li>
                            <li><strong>Xuất xứ:</strong> Nhật Bản</li>
                            <li><strong>Chất liệu:</strong> Bình sơn thép chống gỉ</li>
                        </ul>
                    </div>
