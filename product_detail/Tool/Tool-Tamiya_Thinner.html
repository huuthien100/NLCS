...
<head>
    ...
    <title>Tool - Tamiya Thinner</title>
                ...
                <div id="productCarousel" class="carousel slide" data-bs-ride="productCarousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="../../asset/product/Tool/Tamiya Thinner.jpg" class="d-block w-100"
                                alt="Ảnh sản phẩm 1">
                        </div>
                    </div>
            ...
            <div class="col-lg-6 col-md-6">
                <div class="row">
                    <div class="col-lg-12 col-md-12">
                        <h1 id="product_name">Tamiya Thinner</h1>
                    </div>
                    <div class="col-lg-12 col-md-12">
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 bottom-rule">
                        <h2 class="product-price" style="color: red;">380,000 VNĐ</h2>
                    </div>
                </div>
                <hr>
                <div class="row">
                    <div class="col-lg-12 col-md-12">
                        <ul style="font-size: 18px; font-weight: bold;">
                            ...
                            <li>Thích hợp với sơn Enamel, Tamiya</li>
                ...
                <div class="tab-content">
                    <div class="tab-pane fade show active" id="description" role="tabpanel"
                        ...
                        <p>Tamiya Thinner với dung tích lớn 250ml là lựa chọn tuyệt vời để tạo màu và hoàn thiện
                            các dự án mô hình và thủ công của bạn. <br>Thương hiệu Tamiya từ Nhật Bản cam kết chất lượng
                            và
                            độ bám màu tốt, đặc biệt thích hợp cho việc sơn với sơn loại Enamel và sơn Tamiya.</p>
                        <div class="image-container">
                            <img src="../../asset/product/Tool/Tamiya Thinner.jpg" alt="Ảnh sản phẩm 1">
                        </div>
                    </div>
                    ...
                    <div class="tab-pane fade" id="features" role="tabpanel" aria-labelledby="features-tab">
                        <ul>
                            ...
                            <li><strong>Thích hợp với sơn:</strong> Enamel, Tamiya</li>
