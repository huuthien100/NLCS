...
<head>
    ...
    <title>Tool - Bình khí nén và Air Brush</title>
                ...
                <div id="productCarousel" class="carousel slide" data-bs-ride="productCarousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="../../asset/product/Tool/Bình khí nén và Air Brush.jpg" class="d-block w-100"
                                alt="Ảnh sản phẩm 1">
                        </div>
                    </div>
            ...
            <div class="col-lg-6 col-md-6">
                <div class="row">
                    <div class="col-lg-12 col-md-12">
                        <h1 id="product_name">Bình khí nén và Air Brush</h1>
                    </div>
                    <div class="col-lg-12 col-md-12">
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 bottom-rule">
                        <h2 class="product-price" style="color: red;">1,300,000 VNĐ</h2>
                    </div>
                </div>
                <hr>
                <div class="row">
                    <div class="col-lg-12 col-md-12">
                        <ul style="font-size: 18px; font-weight: bold;">
                            <li>Thương hiệu: YOFE</li>
                            <li>Xuất xứ: Trung Quốc</li>
                            <li>Chất liệu:Nhựa, Kim loại</li>
                            <li>Mã: PQ-08</li>
                            <li>Nguồn: 100-240V</li>
                        </ul>
                    </div>
                </div>
                <hr>
                ...
                <div class="tab-content">
                    <div class="tab-pane fade show active" id="description" role="tabpanel"
                        ...
                        <p>Bình nén khi Vogue Air + Súng Sơn Air Brush nhỏ gọn, dùng để sơn Gunpla </p>
                        <div class="image-container">
                            <img src="../../asset/product/Tool/Bình khí nén và Air Brush.jpg" alt="Ảnh sản phẩm 1">
                        </div>
                    </div>

                    <div class="tab-pane fade" id="features" role="tabpanel" aria-labelledby="features-tab">
                        <ul>
                            <li><strong>Thương hiệu:</strong> YOFE</li>
                            <li><strong>Xuất xứ:</strong> Trung Quốc</li>
                            <li><strong>Chất liệu:</strong> Nhựa, Kim loại</li>
                            <li><strong>Mã sản phẩm:</strong> PQ-08</li>
                            <li><strong>Nguồn điện:</strong> 100-240V</li>
                        </ul>
                    </div>
