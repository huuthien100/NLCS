...
<head>
    ...
    <title>Tool - Bộ dụng cụ lắp ráp mô hình</title>
                ...
                <div id="productCarousel" class="carousel slide" data-bs-ride="productCarousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="../../asset/product/Tool/Bộ dụng cụ cơ bản.jpg" class="d-block w-100"
                                alt="Ảnh sản phẩm 1">
                        </div>
                    </div>
            ...
            <div class="col-lg-6 col-md-6">
                <div class="row">
                    <div class="col-lg-12 col-md-12">
                        <h1 id="product_name">Bộ dụng cụ lắp ráp mô hình</h1>
                    </div>
                    <div class="col-lg-12 col-md-12">
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 bottom-rule">
                        <h2 class="product-price" style="color: red;">300,000 VNĐ</h2>
                    </div>
                </div>
                <hr>
                <div class="row">
                ...
                <div class="tab-content">
                    <div class="tab-pane fade show active" id="description" role="tabpanel"
                        ...
                        <p>Bộ dụng cụ lắp ráp mô hình cơ bản gồm 7 món cho người mới bắt đầu. </p>
                        <div class="image-container">
                            <img src="../../asset/product/Tool/Bộ dụng cụ cơ bản.jpg" alt="Ảnh sản phẩm 1">
                        </div>
                    </div>

                    <div class="tab-pane fade" id="features" role="tabpanel" aria-labelledby="features-tab">
                        <ul>
                            <li>1x Dao cắt kỹ thuật (kèm 1 bộ lưỡi dao thay thế)</li>
                            <li>1x Kìm cắt</li>
                            <li>1x Dụng cụ tách part (tháo gỡ chi tiết khi ráp sai)</li>
                            <li>1x Bút kẻ line (làm nổi bật chi tiết mô hình)</li>
                            <li>1x Kẹp gắp đầu thẳng</li>
                            <li>1x Kẹp gắp đầu cong</li>
                            <li>3x Miếng nhám (3 cấp độ)</li>
                        </ul>
                    </div>
