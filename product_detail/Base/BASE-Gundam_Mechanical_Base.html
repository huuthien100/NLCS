...
<head>
    ...
    <title>Base - Gundam Mechanical Base</title>
                ...
                <div id="productCarousel" class="carousel slide" data-bs-ride="productCarousel">
                    ...
                    <div class="carousel-inner">
                        ...
                        <div class="carousel-item">
                            <img src="../../asset/product/Base/BASE-Gundam Mechanical Base/BASE-Gundam Mechanical Base (2).jpg"
            ...
            <div class="col-lg-6 col-md-6">
                <div class="row">
                    <div class="col-lg-12 col-md-12">
                        <h1 id="product_name">Gundam Mechanical Base</h1>
                    </div>
                    <div class="col-lg-12 col-md-12">
                ...
                <div class="tab-content">
                    <div class="tab-pane fade show active" id="description" role="tabpanel"
                        ...
                        <p>Sả Bàn Gundam Mechanical Base là một phụ kiện quan trọng trong thế giới của mô hình Gundam.
                    ...
                    <div class="tab-pane fade" id="features" role="tabpanel" aria-labelledby="features-tab">
                        <ul>
                            <li><strong>Tỷ lệ:</strong> 1/144 – 1/100</li>
