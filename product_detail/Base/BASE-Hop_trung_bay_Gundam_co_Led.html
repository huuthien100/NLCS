...
<head>
    ...
    <title>Base - Hộp trưng bày Gundam có Led</title>
                ...
                <div id="productCarousel" class="carousel slide" data-bs-ride="productCarousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="../../asset/product/Base/BASE-Hộp trưng bày Gundam có Led/BASE-Hộp trưng bày Gundam có Led - Bigger (1).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 1">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/Base/BASE-Hộp trưng bày Gundam có Led/BASE-Hộp trưng bày Gundam có Led - Bigger (2).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 2">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/Base/BASE-Hộp trưng bày Gundam có Led/BASE-Hộp trưng bày Gundam có Led - MG (1).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 3">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/Base/BASE-Hộp trưng bày Gundam có Led/BASE-Hộp trưng bày Gundam có Led - MG (2).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 4">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/Base/BASE-Hộp trưng bày Gundam có Led/BASE-Hộp trưng bày Gundam có Led - PG (1).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 5">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/Base/BASE-Hộp trưng bày Gundam có Led/BASE-Hộp trưng bày Gundam có Led - PG (2).jpg"
            ...
            <div class="col-lg-6 col-md-6">
                <div class="row">
                    <div class="col-lg-12 col-md-12">
                        <h1 id="product_name">Hộp trưng bày Gundam có Led</h1>
                    </div>
                    <div class="col-lg-12 col-md-12">
                        <span class="badge bg-primary" id="category">Base</span>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 bottom-rule">
                        <h2 class="product-price" style="color: red;">450,000 VNĐ</h2>
                    </div>
                </div>
                <hr>
                <label for="size">Chọn Kích Thước:</label>
                <select id="size" name="size">
                    <option value="MG">MG - 21x21x27 cm</option>
                    <option value="Bigger">Bigger - 21x21x35 cm</option>
                    <option value="PG">PG - 26x26x40 cm</option>
                </select>
                <hr>
                <div class="row">
                    <div class="col-lg-12 col-md-12">
                        <ul style="font-size: 18px; font-weight: bold;">
                            <li>Thương hiệu: VT</li>
                            <li>Xuất xứ: Trung Quốc</li>
                            <li>Chất liệu: Nhựa</li>
                            <li>Kích thước: 21.5x21x26 cm</li>
                            <li>Đèn LED: Sử dụng bảng đèn LED có cổng Micro USB</li>
                        </ul>
                    </div>
                </div>
                <hr>
                ...
                <div class="tab-content">
                    <div class="tab-pane fade show active" id="description" role="tabpanel"
                        ...
                        <p>Sả Bàn Hộp trưng bày Gundam có Led là một phụ kiện quan trọng trong thế giới của mô hình
                            Gundam.
                            Được thiết kế đặc biệt để hỗ trợ và trưng bày các mô hình Gundam, đây là một sản phẩm cần
                            thiết cho các người sưu tập và yêu thích mô hình Gundam.</p>
                    ...
                    <div class="tab-pane fade" id="features" role="tabpanel" aria-labelledby="features-tab">
                        <ul>
                            <li><strong>Thương hiệu:</strong> VT</li>
                            <li><strong>Xuất xứ:</strong> Trung Quốc</li>
                            <li><strong>Chất liệu:</strong> Nhựa</li>
                            <li><strong>Kích thước:</strong> 21.5x21x26 cm</li>
                            <li><strong>Đèn LED:</strong> Sử dụng bảng đèn LED có cổng Micro USB</li>
                        </ul>
                    ...
                    <div class="tab-pane fade" id="reviews" role="tabpanel" aria-labelledby="reviews-tab">
                        <div class="review">
                            <div class="review-avatar">
                                <img src="https://image.ibb.co/jw55Ex/def_face.png" alt="Avatar"
