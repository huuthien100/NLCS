...
<head>
    ...
    <title>Base - Action Base 5 Black</title>
                ...
                <div id="productCarousel" class="carousel slide" data-bs-ride="productCarousel">
                    ...
                    <div class="carousel-inner">
                        ...
                        <div class="carousel-item">
                            <img src="../../asset/product/Base/BASE-Action Base 5 Black/BASE-Action Base 5 Black (2).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 2">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/Base/BASE-Action Base 5 Black/BASE-Action Base 5 Black (3).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 3">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/Base/BASE-Action Base 5 Black/BASE-Action Base 5 Black (4).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 4">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/Base/BASE-Action Base 5 Black/BASE-Action Base 5 Black (5).jpg"
            ...
            <div class="col-lg-6 col-md-6">
                <div class="row">
                    <div class="col-lg-12 col-md-12">
                        <h1 id="product_name">Action Base 5 Black</h1>
                    </div>
                    <div class="col-lg-12 col-md-12">
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 bottom-rule">
                        <h2 class="product-price" style="color: red;">150,000 VNĐ</h2>
                    </div>
                </div>
                <hr>
                <div class="row">
                    <div class="col-lg-12 col-md-12">
                        <ul style="font-size: 18px; font-weight: bold;">
                            <li>Màu sắc: Đen</li>
                            <li>Xuất xứ: Sản phẩm của Bandai, sản xuất tại Nhật Bản</li>
                        </ul>
                    </div>
                </div>
                <hr>
                ...
                <div class="tab-content">
                    <div class="tab-pane fade show active" id="description" role="tabpanel"
                        ...
                        <p>Action Base 5 (Màu Đen) là một sản phẩm thiết kế đặc biệt để trưng bày mô hình Gundam và các
                            mô hình robot khác một cách ấn tượng. <br>Với màu sắc đen bóng, nó tạo điểm nhấn hoàn hảo
                            cho mô
                            hình của bạn và giúp nó nổi bật trên kệ trưng bày.</p>
                    ...
                    <div class="tab-pane fade" id="features" role="tabpanel" aria-labelledby="features-tab">
                        <ul>
                            <ul>
                                <li><strong>Loại:</strong> Phụ kiện dành riêng cho mô hình Gundam</li>
                                <li><strong>Chức năng:</strong> Nâng đỡ, giúp tạo dáng cho các mẫu Gunpla ở các tư thế
                                    khó hoặc tư thế trên không</li>
                                <li><strong>Tương thích với tỷ lệ mô hình:</strong> SD, HG, RG, MG, tỷ lệ 1/144, 1/100
                                </li>
                                <li><strong>Chất liệu:</strong> Nhựa tốt, chi tiết sắc sảo, chắc chắn tạo độ vững cần
                                    thiết để nâng đỡ mô hình</li>
                                <li><strong>Đầu kết nối:</strong> Đi kèm nhiều kiểu đầu nối</li>
                                <li><strong>Màu sắc:</strong> Đen</li>
                                <li><strong>Xuất xứ:</strong> Sản phẩm của Bandai, sản xuất tại Nhật Bản</li>
                            </ul>
