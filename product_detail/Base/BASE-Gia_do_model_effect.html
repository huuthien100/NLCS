...
<head>
    ...
    <title>Base - Giá đỡ mô hình Model Effect</title>
                ...
                <div id="productCarousel" class="carousel slide" data-bs-ride="productCarousel">
                    ...
                    <div class="carousel-inner">
                        ...
                        <div class="carousel-item">
                            <img src="../../asset/product/Base/BASE-Giá đỡ mô hình Model Effect/BASE-Giá đỡ mô hình Model Effect (2).png"
                                class="d-block w-100" alt="Ảnh sản phẩm 2">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/Base/BASE-Giá đỡ mô hình Model Effect/BASE-Giá đỡ mô hình Model Effect (3).png"
                                class="d-block w-100" alt="Ảnh sản phẩm 3">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/Base/BASE-Giá đỡ mô hình Model Effect/BASE-Giá đỡ mô hình Model Effect (4).png"
            ...
            <div class="col-lg-6 col-md-6">
                <div class="row">
                    <div class="col-lg-12 col-md-12">
                        <h1 id="product_name">Giá đỡ mô hình Model Effect</h1>
                    </div>
                    <div class="col-lg-12 col-md-12">
                ...
                <hr>
                <label for="color"><strong>Chọn màu:</strong></label>
                <select id="color" name="color">
                    <option value="den">Đen</option>
                    <option value="trang">Trắng</option>
                    <option value="dentrong">Đen Trong</option>
                    <option value="trangtrong">Trắng trong</option>
                    <option value="xanhrong">Xanh Trong</option>
                    <option value="dotrong">Đỏ Trong</option>
                </select>
                <hr>
                ...
                <div class="tab-content">
                    <div class="tab-pane fade show active" id="description" role="tabpanel"
                        ...
                        <p>Giá đỡ mô hình Model Effect màu đen là một phụ kiện hữu ích cho các mô hình Gundam và mô hình
                            robot khác. <br>Với thiết kế màu sắc đen thời thượng, nó không chỉ giúp trưng bày mô hình
                            một
                            cách ấn tượng mà còn tạo điểm nhấn cho bộ sưu tập của bạn.</p>
                    ...
                    <div class="tab-pane fade" id="features" role="tabpanel" aria-labelledby="features-tab">
                        <ul>
                            ...
                            <li><strong>Khả năng sử dụng:</strong> Dùng được với tất cả các dòng SD BB, MG 1/100, HG
                                RG 1/144</li>
                        </ul>
