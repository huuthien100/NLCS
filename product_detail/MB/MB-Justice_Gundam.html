                ...
                <div id="productCarousel" class="carousel slide" data-bs-ride="productCarousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="../../asset/product/MB/MB-Justice Gundam/MB-Justice Gundam (1).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 1">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/MB/MB-Justice Gundam/MB-Justice Gundam (2).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 2">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/MB/MB-Justice Gundam/MB-Justice Gundam (3).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 3">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/MB/MB-Justice Gundam/MB-Justice Gundam (4).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 4">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/MB/MB-Justice Gundam/MB-Justice Gundam (5).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 5">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/MB/MB-Justice Gundam/MB-Justice Gundam (6).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 6">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/MB/MB-Justice Gundam/MB-Justice Gundam (7).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 7">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/MB/MB-Justice Gundam/MB-Justice Gundam (8).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 8">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/MB/MB-Justice Gundam/MB-Justice Gundam (9).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 9">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/MB/MB-Justice Gundam/MB-Justice Gundam (10).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 10">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/MB/MB-Justice Gundam/MB-Justice Gundam (11).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 11">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/MB/MB-Justice Gundam/MB-Justice Gundam (12).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 12">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/MB/MB-Justice Gundam/MB-Justice Gundam (13).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 13">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/MB/MB-Justice Gundam/MB-Justice Gundam (14).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 14">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/MB/MB-Justice Gundam/MB-Justice Gundam (15).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 15">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/MB/MB-Justice Gundam/MB-Justice Gundam (16).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 16">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/MB/MB-Justice Gundam/MB-Justice Gundam (17).jpg"
            ...
            <div class="col-lg-6 col-md-6">
                <div class="row">
                    <div class="col-lg-12 col-md-12">
                        <h1 id="product_name">Justice Gundam</h1>
                    </div>
                    <div class="col-lg-12 col-md-12">
                ...
                <div class="tab-content">
                    <div class="tab-pane fade show active" id="description" role="tabpanel"
                        ...
                        <p>Justice Gundam từ [Mobile Suit Gundam SEED] đã được tái hiện trong phiên bản METAL BUILD mới
                            với sự hợp tác của Fatum-00, với thiết kế áo choàng hiệp sĩ ấn tượng khi gắn trên lưng.
                            <br>Fatum-00 cũng có dạng tàu chở với cơ chế triển khai độc đáo. <br>Bộ sản phẩm bao gồm
                            nhiều chi
                            tiết độc đáo như gươm tia, bumerang tia, và khớp đặc biệt cho hiển thị Fatum-00 độc lập.
                            <br>Justice Gundam cũng có khả năng tạo ra tư thế mạnh mẽ nhờ cơ chế di chuyển từ METAL
                            BUILD
                            Freedom Gundam CONCEPT2.
                        </p>
                    ...
                    <div class="tab-pane fade" id="features" role="tabpanel" aria-labelledby="features-tab">
                        <ul>
                            ...
                            <ul>
                                ...
                                <li>Súng tia</li>
                                <li>Gươm tia (2 tay cầm, 1 tay cầm nối)</li>
                                <li>Hiệu ứng Gươm tia x 2</li>
                                <li>Hiệu ứng Bumerang tia x 2</li>
                                <li>Kính vững</li>
                                <li>Bộ khớp và cột riêng biệt</li>
                                <li>Đế đặc biệt</li>
                                <li>Anten thay thế</li>
                            </ul>
