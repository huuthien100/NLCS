                ...
                <div id="productCarousel" class="carousel slide" data-bs-ride="productCarousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="../../asset/product/MB/MB-Freedom Gundam/MB-Freedom Gundam (1).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 1">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/MB/MB-Freedom Gundam/MB-Freedom Gundam (2).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 2">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/MB/MB-Freedom Gundam/MB-Freedom Gundam (3).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 3">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/MB/MB-Freedom Gundam/MB-Freedom Gundam (4).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 4">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/MB/MB-Freedom Gundam/MB-Freedom Gundam (5).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 5">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/MB/MB-Freedom Gundam/MB-Freedom Gundam (6).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 6">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/MB/MB-Freedom Gundam/MB-Freedom Gundam (7).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 7">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/MB/MB-Freedom Gundam/MB-Freedom Gundam (8).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 8">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/MB/MB-Freedom Gundam/MB-Freedom Gundam (9).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 9">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/MB/MB-Freedom Gundam/MB-Freedom Gundam (10).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 10">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/MB/MB-Freedom Gundam/MB-Freedom Gundam (11).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 11">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/MB/MB-Freedom Gundam/MB-Freedom Gundam (12).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 12">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/MB/MB-Freedom Gundam/MB-Freedom Gundam (13).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 13">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/MB/MB-Freedom Gundam/MB-Freedom Gundam (14).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 14">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/MB/MB-Freedom Gundam/MB-Freedom Gundam (15).jpg"
                                class="d-block w-100" alt="Ảnh sản phẩm 15">
                        </div>
                        <div class="carousel-item">
                            <img src="../../asset/product/MB/MB-Freedom Gundam/MB-Freedom Gundam (16).jpg"
            ...
            <div class="col-lg-6 col-md-6">
                <div class="row">
                    <div class="col-lg-12 col-md-12">
                        <h1 id="product_name">Freedom Gundam</h1>
                    </div>
                    <div class="col-lg-12 col-md-12">
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 bottom-rule">
                        <h2 class="product-price" style="color: red;">4,400,000 VNĐ</h2>
                    </div>
                </div>
                <hr>
                <div class="row">
                ...
                <div class="tab-content">
                    <div class="tab-pane fade show active" id="description" role="tabpanel"
                        ...
                        <p>Freedom Gundam cực kỳ nổi tiếng của series Mobile Suit Gundam SEED và SEED Destiny nay đã có
                            phiên bản Freedom Gundam Concept 2 - Metal Build.
                            <br>Các fan đã yêu thích Freedom
                            Gundam chắc chắn sẽ càng thích phiên bản này hơn nữa. <br>Các bộ Gundam Metal Build luôn
                            phát
                            hành với số lượng ít hơn rất nhiều so với các dòng Gunpla phổ thông khác. <br>Do đó, nếu bạn
                            thích thì hãy mua ngay đừng chờ đợi nhé, cơ hội tái bản sẽ rất lâu hoặc không có đấy.
                        </p>
                    ...
                    <div class="tab-pane fade" id="features" role="tabpanel" aria-labelledby="features-tab">
                        <ul>
                            <li><strong>Độ chi tiết:</strong> Tốt, đẹp mắt, đã ráp và sơn hoàn chỉnh</li>
                            <li><strong>Series:</strong> Mobile Suit Gundam SEED</li>
                            <li><strong>Khớp cử động:</strong> Linh hoạt, dễ tạo dáng</li>
                            <li><strong>Độ cao:</strong> Khoảng 18cm</li>
                            <li><strong>Thích hợp:</strong> Trưng bày lẫn tạo dáng</li>
                            <li><strong>Phụ kiện đi kèm:</strong> Beam Rifle, bàn tay phụ x4, hiệu ứng Beam Saber x2,
                                chuôi Beam Saber x2, bộ đế trợ giúp, khiên chắn</li>
                            <li><strong>Xuất xứ:</strong> Sản phẩm chính hãng Tamashii Nations - Bandai</li>
                        </ul>
                    </div>
